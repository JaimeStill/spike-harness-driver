...
// that keeps exchange records, and the skills and tools the --skills and --tools directories
// hold, domain.go builds the session domain and mounts its commands, scenarios.go mounts the
