...
// scenarios are defined beside the runner: exchange.go, cancel.go, resume.go, tool.go, and
// skill.go. The tool and skill scenarios bring their own tool and skill, and each has a further
// step for the examples in clutch/examples, which runs when --tools or --skills loaded them.
package scenario
